    ...
    <Box sx={{
      ...
      <Box  sx={{
        ...
        <Box sx={{
          ...
          <Button sx={{width:'200px',my:'auto',color:'white',fontWeight:"700",borderRadius:3,mx:"auto",bgcolor:red[300],":hover":{bgcolor:red.A400}}} onClick={handleDeleteChats}>
            Clear Conversation
          </Button>
        </Box>
      ...
      <Box sx={{
        ...
        <div style={{
          ...
          <IconButton onClick={handleChatRequest} sx={{ml:'auto',color:'white'}}>
            <IoMdSend />
          </IconButton>
        </div>
      </Box>
